...
public class CustomAnalogClock extends View {
    ...
    public void init(Context context) {
        init(context, R.drawable.scenes_clock, R.drawable.hour_hand,
                R.drawable.minute_hand, R.drawable.minute_hand, 0, false, false);
    }
    ...
    public void init(Context context, @DrawableRes int watchFace, @DrawableRes int hourHand,
                     @DrawableRes int minuteHand, @DrawableRes int secondHand, int alpha,
                     boolean is24, boolean hourOnTop) {
        ...
        Drawable Shand = context.getResources().getDrawable(secondHand);

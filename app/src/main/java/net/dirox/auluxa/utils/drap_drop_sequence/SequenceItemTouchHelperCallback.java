...
package net.dirox.auluxa.utils.drap_drop_sequence;
...
public class SequenceItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    private boolean isItemSwipeEnable = false;
    ...
    public void setItemSwipeEnable(boolean itemSwipeEnable) {
        isItemSwipeEnable = itemSwipeEnable;
    }
    /*@Override
